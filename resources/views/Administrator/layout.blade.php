        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>Resturants</a>
                        <ul>
                            <li><a href="#">View Resturants</a></li>
                            <li><a href="#">Add New Resturant</a></li>
                        </ul>
                    </li>

                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>Customers</a>
                        <ul>
                            <li><a href="#">View Resturants</a></li>
                    ...
                    {{-- <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>Delivery Boy</a>
                        <ul>
                            <li><a href="#">Add Menu</a></li>
                            <li><a href="#">Menu Lists</a></li>
                        </ul>
                    </li> --}}

                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>Orders</a>
                        <ul>
                            <li><a href="#">Running Orders</a></li>
                            <li><a href="#">All Orders</a></li>
                        </ul>
                    </li>
                    {{-- <li><a href="{{url('admin/view-tutorials')}}"><i class="ti-file"></i>Tutorials</a></li> --}}

                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>Ads</a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>Package Plans</a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>Settings</a>
                        <ul>
