                        ...
                        <div class="card">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    <div class="stat-text">Total Resturants</div>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    <div class="stat-text">Pending Resturants</div>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    <div class="stat-text">Active Resturants</div>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    <div class="stat-text">Inactive Resturants</div>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="stat-widget-one">
                                ...
                                <div class="stat-content dib">
                                    <div class="stat-text">Block Customers</div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table student-data-table m-t-20">
                                        <thead>
                                            <tr>
                                                <th><label><input type="checkbox" value=""></label>Resturant Name</th>
                                                <th>Owner Name</th>
                                                <th>City</th>
                                                <th>Address</th>
                                                <th>Joining Date</th>
